...
<body>
	...
	<main class="col offset-md-2 bg-faded">
		<div class="container" style="margin-top: 70px">
			...
			<form action="joinMember.do" class="form-horizontal" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-2">
						<input class="form-control" name="fnum" type="text" value="010">
					</div>
					<div class="col-sm-3">
						<input class="form-control" name="lnum" type="text">
					</div>
				</div>
			<div class="form-group row">
			...
			<div class="col-sm-5">
				<input type="text" name="eamil1" class="form-control"maxlength="18">
				@
				<select name="eamil2" class="form-control">
